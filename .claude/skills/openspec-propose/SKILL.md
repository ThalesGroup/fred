...
- Prompt: "The artifacts are ready for review. When you are ready, run `/opsx:apply` in Claude Code or `$openspec-apply-change` in Codex, or ask me to apply this change."
