...
| **Agent execution** | Multi-agent orchestration (ReAct + graph), SSE streaming, tool use, HITL, MCP                                             | [Agent authoring guide](../authoring/AGENTS.md) · [fred-agents pod](../apps/fred-agents/README.md)                                                                                                                                                                 |
