...
[`design/CONTROL-PLANE-PRODUCT-CONTRACT.md §35`](design/CONTROL-PLANE-PRODUCT-CONTRACT.md);
...
| AUTHZ-01 fit | Org-level `can_manage_platform: admin` covers "policies/purge, **lifecycle**"; `session/checkpoint` ownership keeps an **admin branch → `can_manage_platform`**. | [platform/REBAC.md](platform/REBAC.md) |
