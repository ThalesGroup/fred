...
|---|---|---|---|---|
| M1 | Multi-agent conversational memory | Dimitri | Core done — 4 hardening branches open | [M1-multi-agent-memory.md](M1-multi-agent-memory.md) |
| P1 | Prompt safety + library | Dimitri | Active — D1b, D2, D3 open; E/F deferred | _to write_ |
| S1 | E2E live stack validation | Simon | In progress — blocked on live pod | _to write_ |
| 6C | Chat UI — agent options panel + session title | Félix | In progress — blocked on S1 gate | _to write_ |
| C1 | Pod catalog + agent instance config | Dimitri | Mostly done — model profiles deferred | _to write_ |
| 5E | Frontend agentic-backend cleanup | Félix | Not started | _to write_ |
| O1 | Agent evaluation harness (deepeval) | Odélia | Not started — RFC exists | _to write_ |

### Recently closed

| Track | Title | Owner | Closed | Manifest |
|---|---|---|---|---|
| RT-1 / FE-1 | Typed ChatContext round-trip | Dimitri / Félix | 2026-05-11 | _to write_ |
| R1 | fred-runtime quality refactor | Simon | 2026-04-27 | _to write_ |
| D1 | Control-plane developer CLI | Dimitri | 2026-04-25 | _to write_ |
| F track | Session lifecycle APIs (F1, F2) | Florian | 2026-05-06 | _to write_ |
| 6A / 6B | Chat UI architecture + markdown rendering | Félix / Dimitri | 2026-05-04 | _to write_ |
| 5A–5D | Frontend migration phases | Multiple | 2026-05-04 | _to write_ |
