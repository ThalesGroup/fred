...
> **Design:** [`CHAT-COMPONENT-SPECS.md §12`](../design/CHAT-COMPONENT-SPECS.md)  
...
> **ID:** `CHAT-07` > **Design:** [`CHAT-COMPONENT-SPECS.md §13`](../design/CHAT-COMPONENT-SPECS.md) > **Scope:** frontend-only except Step 3 (one additive backend field + OpenAPI regen)
...
**Design:** `docs/swift/design/CHAT-COMPONENT-SPECS.md`  
**ID:** CHAT-09  
...
- [x] Amend the rendering spec (now `CHAT-COMPONENT-SPECS.md §14`) to reference the guard
...
**ID:** `CHAT-15` · **Owner:** Simon · **Design:** [`CONTROL-PLANE-PRODUCT-CONTRACT.md`](../design/CONTROL-PLANE-PRODUCT-CONTRACT.md)
...
**ID:** `CHAT-16` · **Owner:** Dimitri · **Design:** [`RUNTIME-EXECUTION-CONTRACT.md §8.21`](../design/RUNTIME-EXECUTION-CONTRACT.md)
...
| Phase                                       | Status               | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AgentFormModal refactor                     | ✅ Done (2026-04-28) | `TemplateBrowser` + `TemplateCard` + `TuningFieldRenderer` + `AgentFormBody` extracted; all field types; grouping; MCP read-only section; edit context bar + metadata footer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| CHAT-07 – Composer state hardening          | ✅ Done (2026-05-24) | All 5 steps implemented (`CHAT-COMPONENT-SPECS.md §13`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| CHAT-09 – Streaming render guard            | ✅ Done (2026-05-28) | Streaming markdown now splits into safe rendered prose plus one pending fence preview block. Any supported open fence (` ```lang `, ` ```mermaid `, `$$`, `:::`) shows a `CodeBlock` shell until completion; Mermaid then hands off to `MermaidBlock` for final SVG rendering. No backend changes, no new deps. Manual live-pod validation remains a non-blocking follow-up.                                                                                                                                                                                                                                                                                                   |
