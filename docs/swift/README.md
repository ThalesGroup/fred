...
| [`FRED-INTEGRATED-APPLICATIONS-RFC.md`](rfc/FRED-INTEGRATED-APPLICATIONS-RFC.md)     | Generic framework for integrating multiple applications as native, collaborative-team-scoped Fred pages with manifest-driven discovery, capability enablement, and isolated frontend modules           |
