...
| `FILES-04` | `UNIFIED-FILESYSTEM` | Dimitri | RFC-only — consolide dans FILES-01 le modele utilisateur a 4 racines: Resources, Mon espace, Espace d'equipe, Agents | [CHAT-UI-BACKLOG §4.6](backlog/CHAT-UI-BACKLOG.md) | [AGENT-FILESYSTEM-RFC](rfc/AGENT-FILESYSTEM-RFC.md) | `TBD` |
