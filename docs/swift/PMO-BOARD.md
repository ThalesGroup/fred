...
| `FILES-06` | `GCS-STORAGE-BACKEND` | Dimitri | En cours — backend GCS natif livré ; décision signée réouverte pour les lectures tabulaires Parquet, avec garde-fou d'échec explicite avant implémentation | [BACKLOG §Phase STORAGE](backlog/BACKLOG.md) | [GCS-TABULAR-SIGNED-URL-RFC](rfc/GCS-TABULAR-SIGNED-URL-RFC.md) | branch `1795-…-native-google-cloud-storage-backend` ; GitHub issue #1795 |
