...
| `FILES-04` | `UNIFIED-FILESYSTEM` | Dimitri | En cours — UI 4 racines livrée bout-en-bout (2026-06-24): routage des sorties agents vers le sous-arbre agents + isolation runtime (G1), provenance dérivée du chemin (G4), badges + racine Agents. Reste: partage par copie (G5), helpers SDK (G7), durcissement KF côté principal (G1b, différé agents de confiance) | [CHAT-UI-BACKLOG §4.6](backlog/CHAT-UI-BACKLOG.md) | [AGENT-FILESYSTEM-RFC](rfc/AGENT-FILESYSTEM-RFC.md) | branche `…-final` |
