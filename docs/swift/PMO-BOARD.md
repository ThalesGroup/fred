...
| `RUNTIME-07` | `ANTHROPIC-NATIVE-PROVIDER` | Dimitri | **Clos 2026-06-24** — ANTHROPIC dans ModelProvider, branche factory ChatAnthropic, 13 tests, profil catalogue, §8.9 contrat | [FRED-RUNTIME-QUALITY §RUNTIME-07](backlog/FRED-RUNTIME-QUALITY.md) | [ANTHROPIC-NATIVE-PROVIDER-RFC](rfc/ANTHROPIC-NATIVE-PROVIDER-RFC.md) | [PR #1814](https://github.com/ThalesGroup/fred/pull/1814) |
