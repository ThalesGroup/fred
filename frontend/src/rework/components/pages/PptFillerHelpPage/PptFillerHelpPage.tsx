...
/**
 * Standalone documentation page for the PPT Filler toolkit. Opened in a new tab from the
 * agent creation form, so it is a top-level route (no app chrome). The content lives as
 * localized markdown under ``public/`` (``ppt-filler-help.md`` / ``.fr.md``) — text-first
 * and easy to edit, and rendered with the shared MarkdownRenderer (same one as GCU /
 * documents). The author can later drop screenshots into the markdown.
 */
