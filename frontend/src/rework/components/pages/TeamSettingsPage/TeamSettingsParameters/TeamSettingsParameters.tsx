...
export default function TeamSettingsParameters({ team }: TeamSettingsParametersProps) {
  ...
  const [uploadBanner] = useUploadTeamBannerKnowledgeFlowV1TeamsTeamIdBannerPostMutation();
  ...
  const handleSaveDescription = () => {
    ...
    updateTeam({
      teamId: team.id,
      teamUpdate: { description: newDescription },
    });
  };
  ...
  const handleSaveIsPrivate = () => {
    ...
    updateTeam({
      teamId: team.id,
      teamUpdate: { is_private: newPrivate },
    });
  };
