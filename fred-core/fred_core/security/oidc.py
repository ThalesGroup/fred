...
async def get_current_user(token: str = Security(oauth2_scheme),
                           ...
                           configuration=Depends(get_config)) -> KeycloakUser:
  ...
  if configuration.app.gcu_version and user_details and user_details.gcuVersionAccepted != configuration.app.gcu_version:
