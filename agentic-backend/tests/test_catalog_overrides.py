...
def test_agents_catalog_is_ignored_when_agents_defined_in_config(
...
def test_agents_catalog_applies_when_agents_missing_from_config(
    tmp_path, monkeypatch
) -> None:
...
def test_mcp_catalog_is_ignored_when_mcp_defined_in_config(
    tmp_path, monkeypatch
) -> None:
    configuration = _minimal_configuration()
...
def test_mcp_catalog_applies_when_mcp_missing_from_config(tmp_path, monkeypatch) -> None:
    configuration = _minimal_configuration(include_mcp=False)
    mcp_catalog = tmp_path / "mcp_catalog.yaml"
    mcp_catalog.write_text(
        """
version: v1
...
def test_models_catalog_is_ignored_when_models_defined_in_config(
    tmp_path, monkeypatch
) -> None:
    configuration = _minimal_configuration()
...
def test_models_catalog_applies_when_models_missing_from_config(
    tmp_path, monkeypatch
) -> None:
