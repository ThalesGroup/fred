...
def upgrade() -> None:
    ...
    sa.Column('blocked_json', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('session_data', postgresql.JSONB(astext_type=sa.Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
