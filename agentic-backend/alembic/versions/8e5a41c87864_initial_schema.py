...
def upgrade() -> None:
    ...
    sa.Column('session_data', sa.JSON().with_variant(sa.JSON(), 'sqlite'), nullable=True),
    ...
    sa.Column('parts_json', postgresql.JSONB(astext_type=sa.Text()).with_variant(sa.JSON(), 'sqlite'), nullable=True),
