...
**Justification Fred** : toujours garder une base stable pour sécuriser les démonstrations.
...
- EcoAdvisor cite les sources : “Facteur CO₂ automobile : 0.192 kg/km (source ADEME 2024)”
- Données vivantes, crédibles, reproductibles

**Justification Fred** : montre que l’agent repose sur des référentiels offerts par des APIs publiques.
...
- Utilisation : “Ligne C7 : retards de 10 minutes aujourd’hui, travaux près du Tonkin.”
...
- Utilisation : “Trafic élevé sur Villeurbanne → +15 min estimées en voiture.”
...
- Utilisation : “Pluie légère prévue. Vélo possible mais moins confortable.”
...
- Mettre en avant les lignes cyclables proches
- Afficher une carte (Leaflet / Mapbox) ou une pseudo-carte simple

### 4.2 Tableaux UI enrichis

Transformer le tableau Markdown en UI avec :
...
**Justification Fred** : une démo fluide et rassurante, sans dépendre à 100 % de la spontanéité.
...
Elle ancre EcoAdvisor dans une architecture propre, testable et maintenable.
