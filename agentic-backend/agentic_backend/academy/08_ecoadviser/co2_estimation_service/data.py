...
DEFAULT_EMISSION_FACTORS: List[EmissionFactorDict] = [
    ...
    {
        "mode": "escooter",
        "label": "Trottinette électrique personnelle / partagée",
        "category": "micro_mobility",
        "factor_kg_per_km": 0.01,
        "unit": "kgCO2e/km",
        "source": "ADEME Base Carbone 2024 (micro-mobilités)",
        "source_url": "https://data.ademe.fr/datasets/base-carbone",
        "last_update": "2024-02-15",
        "geography": "Usage urbain",
        "notes": "Hypothèse ADEME sur l'électricité consommée et la fabrication (trottinettes partagées).",
        "aliases": [
            "e_scooter",
            "escooter",
            "electric_scooter",
