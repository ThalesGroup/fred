...
class AgentTaskRunner:
    def __init__(self, configuration: Configuration) -> None:
        ...
        self._agent_manager = AgentManager(configuration, self._agent_loader, get_agent_store())
        self._agent_factory = AgentFactory(configuration, self._agent_manager, self._agent_loader)
