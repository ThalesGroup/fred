CODE_QUALITY_DIRS := libs/fred-core libs/fred-sdk libs/fred-runtime libs/fred-capability-writable-document libs/fred-capability-ppt-filler libs/fred-capability-html-artifact apps/fred-agents apps/control-plane-backend apps/knowledge-flow-backend apps/frontend
TEST_DIRS := libs/fred-core libs/fred-sdk libs/fred-runtime libs/fred-capability-writable-document libs/fred-capability-ppt-filler libs/fred-capability-html-artifact apps/fred-agents apps/control-plane-backend apps/knowledge-flow-backend apps/frontend
