...
class TestMetadataService:
    ...
    def test_delete_document_metadata(self, monkeypatch):
        mock_doc = DocumentMetadata(source_type=SourceType("push"), document_uid="doc1", document_name="doc.md")
    ...
    def test_update_document_retrievable(self, monkeypatch, dummy_update):
        mock_updated = DocumentMetadata(source_type=SourceType("push"), document_uid="doc1", document_name="doc.md", retrievable=True)
