...
from app.features.content.agent_asset_controller import AgentAssetController
...
def create_app() -> FastAPI:
    ...
    mcp_agent_assets = FastApiMCP(
        ...
        description=(
            "CRUD interface for per-user agent assets (e.g., PPTX templates). "
    ...
    mcp_agent_assets.mount_http(mount_path=f"{mcp_prefix}/mcp-agent-assets")
