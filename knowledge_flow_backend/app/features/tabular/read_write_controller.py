...
class ReadWriteTabularController:
    """
    ...
    def __init__(self, router: APIRouter):
        ...
        self.service = TabularService(self.context.get_read_write_store())
        self._register_routes(router)

    def _register_routes(self, router: APIRouter):
        @router.get("/tabular_read_write/tables", response_model=List[str], tags=["Tabular"], operation_id="list_table_names", summary="List all available table names")
        ...
        @router.get("/tabular_read_write/schemas", response_model=List[TabularSchemaResponse], tags=["Tabular"], operation_id="get_all_schemas", summary="Get schemas for all available tables")
