...
open a draft pull request for review. If the user explicitly asks to skip the
end-of-work OpenSpec record for a small issue fix, honor that scope and record
the skipped workflow step in the close-out.
