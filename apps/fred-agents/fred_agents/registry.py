...
def build_registry() -> dict[str, ReActAgentDefinition | GraphAgentDefinition]:
    ...
    - fred.github.basic-assistant  Lightly equipped ReAct agent. Defaults to the
                               conversation-attachments pack and reasoning, so
                               a user can drop a file in and ask about it. The
                               middle rung: the blank slate stays blank, this
                               one covers the median first use.
    ...
    return {
        ...
        BASIC_ASSISTANT_AGENT.agent_id: BASIC_ASSISTANT_AGENT,
