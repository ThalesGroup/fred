...
# Pull-mode source configs (local_path, minio, sphere, github, gitlab) were removed:
# untested, and sphere/github/gitlab never had a working loader wired to them.
DocumentSourceConfig = PushSourceConfig
...
class Configuration(BaseModel):
    ...
    document_sources: Dict[str, DocumentSourceConfig] = Field(default_factory=dict, description="Mapping of source_tag identifiers to push source configurations")
