...
from knowledge_flow_backend.core.processors.input.lightweight_markdown_processor.lite_ppt_to_md_processor import (
    LitePptToMdExtractor,
)


class FastLitePptProcessor(BaseFastTextProcessor):
    """Adapter to use LitePptToMdExtractor (legacy .ppt) within the FastText infrastructure."""

    def __init__(self) -> None:
        self._lite = LitePptToMdExtractor()
