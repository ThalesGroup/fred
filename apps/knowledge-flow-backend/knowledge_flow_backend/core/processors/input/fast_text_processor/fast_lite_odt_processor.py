...
from knowledge_flow_backend.core.processors.input.lightweight_markdown_processor.lite_odt_to_md_processor import (
    LiteOdtToMdProcessor,
)


class FastLiteOdtProcessor(BaseFastTextProcessor):
    """Adapter to use LiteOdtToMdProcessor (OpenDocument .odt) within the FastText infrastructure."""

    def __init__(self) -> None:
        self._lite = LiteOdtToMdProcessor()
