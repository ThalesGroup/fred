...
from knowledge_flow_backend.core.processors.input.lightweight_markdown_processor.lite_doc_to_md_processor import (
    LiteDocToMdProcessor,
)
...
class FastLiteDocProcessor(BaseFastTextProcessor):
    """Adapter to use LiteDocToMdProcessor (legacy .doc) within the FastText infrastructure."""

    def __init__(self) -> None:
        self._lite = LiteDocToMdProcessor()
