...
export type HealthzKnowledgeFlowV1HealthzGetApiArg = {
  person?: string | null;
  run?: string | null;
  agent?: string | null;
};
export type ReadyKnowledgeFlowV1ReadyGetApiResponse = /** status 200 Successful Response */ any;
export type ReadyKnowledgeFlowV1ReadyGetApiArg = {
  person?: string | null;
  run?: string | null;
  agent?: string | null;
};
