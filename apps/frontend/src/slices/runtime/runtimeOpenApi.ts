...
export type ExecuteAgentStreamApiArg = {
  ...
  run?: string | null;
  agent?: string | null;
  request: RuntimeExecuteRequest | RuntimeReconnectRequest;
};
...
export type RuntimeReconnect = {
  after_sequence?: number | null;
  run_id: string;
};
export type RuntimeReconnectRequest = {
...
export type AgentTuning = {
  ...
  role: string;
  /** Maximum run duration in seconds; unset uses the deployment default. */
