  ...
  const parse = (text: string, name: string) => {
    ...
    try {
      if (name.endsWith(".json")) {
        ...
        if (arr.length > 200) {
          setError("Maximum 200 cas autorisés.");
          return;
        }
        onParsed(
          arr.map((item: any) => ({
...
export default function EvaluationCampaignCreate() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate(`/settings/evaluations/${result.campaign_id}`);
    } catch (e: any) {
  ...
  return (
    <Container maxWidth="md" sx={{ py: 3 }}>
      <TopBar
        ...
        description="Configurez la cible, le dataset et la politique de scoring"
      >
        ...
        <StepSlide active={step === 0}>
          <Stack spacing={3}>
            <TextField
              ...
              fullWidth
              required
              placeholder="ex. Validation GitHub Assistant v2"
            />
            ...
            {targetKind === "managed_instance" ? (
              ...
              <Stack spacing={2}>
                ...
                <TextField
                  ...
                  fullWidth
                  required
                  placeholder="ex. fred.github.assistant"
                />
              </Stack>
            )}
            ...
            >
              <Typography variant="caption" color="text.secondary">
                Les URLs de runtime ne sont jamais exposées au navigateur. Seuls des identifiants contrôlés sont
                acceptés.
              </Typography>
            </Box>
          </Stack>
          ...
          <StepSlide active={step === 1}>
            <Stack spacing={3}>
              ...
              <Box>
                ...
                <Stack spacing={2}>
                  {cases.map((row, idx) => (
                    <Card
                      key={row.id}
                      sx={{ bgcolor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}
                    >
                      <CardContent>
                        <Stack direction="row" alignItems="flex-start" spacing={1}>
                          <Box sx={{ flex: 1 }}>
                            <Stack spacing={1.5}>
                              ...
                              />
                              <TextField
                                label="Sortie attendue (optionnel)"
              ...
              <Box>
                ...
                {jsonCases.length > 0 && (
                  <Alert severity="success" sx={{ mt: 1 }}>
                    {jsonCases.length} cas importés via JSON.
                  </Alert>
                )}
              </Box>
              ...
              <Box>
                ...
                {csvCases.length > 0 && (
                  <Alert severity="success" sx={{ mt: 1 }}>
                    {csvCases.length} cas importés via CSV.
                  </Alert>
                )}
              </Box>
          ...
          <StepSlide active={step === 2}>
            <Stack spacing={3}>
              <TextField
                ...
                fullWidth
                helperText="Identifiant du modèle d'évaluation, ex. mistral-small"
              />
              <Stack direction="row" spacing={2}>
                <TextField
      ...
      <Stack direction="row" justifyContent="space-between" sx={{ mt: 4 }}>
        ...
        {step < STEPS.length - 1 ? (
          ...
          <Button color="primary" variant="filled" size="medium" onClick={handleSubmit} disabled={isCreating}>
