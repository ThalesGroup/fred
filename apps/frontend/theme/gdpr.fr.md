# TEST DE SURCHARGE DU THÈME - ceci n'est pas une vraie politique de confidentialité
...
2. Il a extrait `gdpr.fr.md` dans le répertoire d'overlay, hors de la racine web.
...
dans `apps/frontend/theme/gdpr.fr.md` et n'existe que pour rendre l'archive
complète et la surcharge vérifiable de bout en bout.

Gardez `gdpr.md` à côté. L'application demande d'abord `gdpr.<langue>.md` : sans
