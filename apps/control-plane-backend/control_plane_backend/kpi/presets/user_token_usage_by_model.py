...
async def query_user_token_usage_by_model(
    ...
    body: dict[str, Any] = {
        ...
        "aggs": {
            "by_model": {
                ...
                # talks to a handful of models, not thousands — so fetch all of
...
USER_TOKEN_USAGE_BY_MODEL_PRESET = PresetDef(
    name="user_token_usage_by_model",
