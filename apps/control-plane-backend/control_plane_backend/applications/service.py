...
async def list_team_applications(
    *,
    ...
    catalog_source: ApplicationCatalogSource | None = None,
) -> ApplicationList:
    """Return registered applications admitted for one collaborative team.
    ...
    source = catalog_source or ConfiguredApplicationCatalogSource(
        tuple(deps.configuration.platform.application_sources)
    )
