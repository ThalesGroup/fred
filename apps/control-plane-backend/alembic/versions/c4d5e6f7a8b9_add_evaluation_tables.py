...
down_revision: Union[str, Sequence[str], None] = "b4c5d6e7f8a9"  # pragma: allowlist secret
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_evaluation_campaign_team_id"), "evaluation_campaign", ["team_id"], unique=False)
    op.create_index(op.f("ix_evaluation_campaign_task_id"), "evaluation_campaign", ["task_id"], unique=False)

    op.create_table(
        "evaluation_case",
        sa.Column("case_id", sa.String(), nullable=False),
        sa.Column("campaign_id", sa.String(), sa.ForeignKey("evaluation_campaign.campaign_id"), nullable=False),
    ...
    op.create_index(op.f("ix_evaluation_case_campaign_id"), "evaluation_case", ["campaign_id"], unique=False)

    op.create_table(
        "evaluation_metric_result",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("case_id", sa.String(), sa.ForeignKey("evaluation_case.case_id"), nullable=False),
        sa.Column("campaign_id", sa.String(), nullable=False),
        sa.Column("name", sa.String(length=255), nullable=False),
    ...
    op.create_index(op.f("ix_evaluation_metric_result_case_id"), "evaluation_metric_result", ["case_id"], unique=False)
    op.create_index(op.f("ix_evaluation_metric_result_campaign_id"), "evaluation_metric_result", ["campaign_id"], unique=False)


def downgrade() -> None:
    op.drop_index(op.f("ix_evaluation_metric_result_campaign_id"), table_name="evaluation_metric_result")
    op.drop_index(op.f("ix_evaluation_metric_result_case_id"), table_name="evaluation_metric_result")
    ...
    op.drop_index(op.f("ix_evaluation_campaign_task_id"), table_name="evaluation_campaign")
    op.drop_index(op.f("ix_evaluation_campaign_team_id"), table_name="evaluation_campaign")
