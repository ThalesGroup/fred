...
import pytest
from fred_capability_documents.document_extract import DocumentExtractCapability
from fred_capability_documents.document_extract.capability import DocumentExtractConfig
from fred_capability_documents.document_read_common import (
    DEFAULT_PAGE_MAX_CHARS,
    DocumentReadConfig,
    resolve_page_max_chars,
)
from fred_capability_documents.document_verbatim import DocumentVerbatimCapability
...
_VERBATIM_EP = "fred_capability_documents.document_verbatim:DocumentVerbatimCapability"
_EXTRACT_EP = "fred_capability_documents.document_extract:DocumentExtractCapability"
