...
import pytest
from fred_capability_documents.document_similarity import DocumentSimilarityCapability
...
_ENTRY_POINT_VALUE = (
    "fred_capability_documents.document_similarity:DocumentSimilarityCapability"
)
