...
import httpx
import pytest
from fred_capability_document_access import (
...
# ---------------------------------------------------------------------------
# list_document_tree (summarize_document split out into its own capability,
# document_summarize, now in the fred-capability-documents package — see its
