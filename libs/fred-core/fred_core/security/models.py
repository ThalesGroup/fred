...
class Resource(str, Enum):
    ...
    # Knowledge-base-type team scoping (docs/swift/rfc/KNOWLEDGE-BASE-RFC.md §6):
    # same shape as CAPABILITY, kept as its own type rather than a namespaced
    # capability id — a knowledge base type is not "something an agent uses".
