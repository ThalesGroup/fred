...
def test_base_prompt_override_replaces_the_agent_block_and_nothing_else() -> None:
    # `AgentInvocationRequest.system_prompt` replaces the agent block; the
    # runtime-owned blocks around it are what a caller must not be able to drop.
    binding = _binding()
