...
from app.features.frugal.structure.workload_scores.compression import CompressionScore
from app.features.frugal.structure.workload_scores.cpu import CpuScore
from app.features.frugal.structure.workload_scores.io import IoScore
from app.features.frugal.structure.workload_scores.ram import RamScore
from app.features.frugal.structure.workload_scores.scalability import ScalabilityScore
