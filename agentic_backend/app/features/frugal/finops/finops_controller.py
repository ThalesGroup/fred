...
from app.common.structures import PrecisionEnum, Series, CompareResult
...
class FinopsController:
    def __init__(self, app: APIRouter):
        ...
        async def get_cloud_cost_route(
            start: datetime,
            end: datetime,
            cluster: str,
        ...
        async def get_compare_cloud_cost(
            ...
            try:
                return service.consumption_finops_compare(
